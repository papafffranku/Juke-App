...
class _SongUploadState extends State<SongUpload> {
        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled){
          return <Widget>[
            CupertinoSliverNavigationBar(
              backgroundColor: Color(0xff0e0e15),
              largeTitle: Text('Upload',style: TextStyle(color: CupertinoColors.white),),
            ...
            children: [
                  ...
                  children: [
                    if (path=='')...[
                      IconButton(
                        ...
                        icon: Icon(Icons.upload),color: Color(0xff5338FF),iconSize: 50,)
                    ]else...[
                      Expanded(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: (){},
                          icon: Icon(CupertinoIcons.info,color: CupertinoColors.systemGrey,),
                          tooltip: 'This determines which charts your song gets featured on',
                        ),
                      ],
                    ),
                    SizedBox(width: 30,),
                    DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        value: _current,style: TextStyle(color: CupertinoColors.white,fontSize: 18),
                      ),
                    ),
                  ],
                ),
                        ...
                        onChanged: (bool value){
                          setState(() {
                            ...
                            if(prv==false){
                              ...
                              prvmsg='Only you will be able to view this song';
                            }
                            print('prv: $prv');
                          });
                        }
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    AnimatedCrossFade(
                        firstChild: Text('This song is public',style: TextStyle(color: CupertinoColors.activeBlue),),
                        secondChild: Text('Only you will be able to view this song',style: TextStyle(color: CupertinoColors.activeBlue),),
                        crossFadeState: prv
  ...
  Future<void> Uploader(File cover, String cover_key, File upf1, String song_key, String uid) async {
    // await S3Helper.uploadFileS3(cover, cover_key);
    // await S3Helper.uploadFileS3(upf1, song_key);
    await dbsong(song_key,upf1,cover_key,SongNameController.text,SongDescController.text,uid);
  }

  Future <void> dbsong(String song_key, File upf1, String cover_key, String sname, String desc, String uid) async {
